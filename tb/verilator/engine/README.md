...
| 16 | three lost responses clear it (802.1AS-2011 10.2.4.1) |

All seven planted mutations (ladder trigger, both thresholds, all three
timeout values, a dead ratio divide) turn the run red.
