...
| 18b | a torn-bank delayed dispatch is DROPPED by the closing seq guard, never a wrongful takeover |
...
All twenty-five planted mutations (ladder trigger, both pdelay
...
swapped vector/identity compare order) turn the run red.
