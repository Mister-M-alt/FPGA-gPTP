...
> Archived: 2026-08-31
>
> Current successor: [current project guide](../../../README.md)
...
the option on it owns the retired controller duties on the soft
...
the retired host services stay external until parent issue #116 lands.
...
is retired. Offsets beyond 20 us (the legacy step threshold
...
that default-on publication transition; #117 still owns physical
...
- PHC: the engine's adjfine pulse is latched to a level in the shadow and its
  ...
  the retired control writes; settime stays with the CSR face (boot sets
